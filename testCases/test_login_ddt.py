...
class Test_002_DDT_Login:  # Test case , 1 test-case can contain many tests, as demonstrated below.
    ...
    def test_login_ddt(self, setup):        # data driven test , 'setup' is Fn. called in this method as parameter,
        ...
        for r in range(2, self.rows+1):
            ...
            #..then we have to close website and reopen a fresh login pg. I tried to do this in below code but i failed.
            #So, try it in spare time, i think some features of selenium.webdriver will be needed OR
            # variable/parameter/attribute etc passing is causing error, that i dont know.
